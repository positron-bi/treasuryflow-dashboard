...
def protect_html(html: str, excel_path: str | Path, dashboard: str = "treasury", title: str = "داشبورد جریان نقد پوزیترون") -> str:
    ...
    return f'''<!doctype html><html lang="fa" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{safe_title}</title><style>
